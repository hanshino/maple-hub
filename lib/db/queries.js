...
export async function upsertUnionChampion(ocid, champions, totalBadgeInfo) {
  ...
  await Promise.all([
    db.delete(characterUnionChampion).where(eq(characterUnionChampion.ocid, ocid)),
    db.delete(characterUnionChampionBadges).where(eq(characterUnionChampionBadges.ocid, ocid)),
  ]);
